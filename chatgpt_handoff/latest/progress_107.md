...
- Feature commits: `1390acd` (implementation), `ebc4b93`, `d3775cb`, `aa37b5d` (review fixes and report corrections) on `feat/track-matte-source-picker`.
- Fast-forward merged into `main` (`14c84af..aa37b5d`) and pushed to `origin/main`; no normal merge commit, rebase, or force push.
