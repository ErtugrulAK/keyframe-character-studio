...
| `integration/v6-ui-ograf-public-controls-rc` | Consolidated public-controls integration RC | RC@`4e4c269` + public-controls tip | CURRENT / PUSHED | `c7f5bb1` | None without explicit approval | Request main merge approval |
