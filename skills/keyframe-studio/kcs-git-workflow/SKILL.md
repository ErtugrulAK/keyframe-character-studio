...
description: Use when doing git operations in Keyframe Studio.
version: 1.0.0
author: senmu
license: MIT
metadata:
  hermes:
    tags: [keyframe-studio, git, commits, merges, workflow]
    related_skills: [kcs-constitution, kcs-branch-strategy]
---

# Git Workflow

Hermes port of the repo's `.agents/workflows/git.md`.
...
Always follow the project's branching strategy defined in the `kcs-branch-strategy` skill (port of `.agents/BRANCH_STRATEGY.md`).
