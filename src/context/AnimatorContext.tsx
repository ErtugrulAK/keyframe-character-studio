            ...
            {toasts.map((t) => (
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${t.type === 'success' ? 'var(--accent-teal)' : t.type === 'error' ? '#f43f5e' : '#00d2ff'}`,
                  boxShadow: `0 12px 35px rgba(0,0,0,0.7), 0 0 20px ${t.type === 'success' ? 'var(--accent-teal-glow)' : t.type === 'error' ? 'rgba(244, 63, 94, 0.3)' : 'rgba(0, 210, 255, 0.3)'}`,
                  color: '#ffffff',
                  display: 'flex',
                  alignItems: 'center',
